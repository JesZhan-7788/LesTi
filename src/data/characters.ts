...
export const characters: Character[] = [
  {
    ...
    quote: {
      original: "Some lesbians, you know what? You have to break up with them more than once.",
      translation: "有些女同性恋，你不得不与之分手的次数不止一次。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "It's not a fucking woman's job to be consumed and invaded and spat out so that some fucking man can evolve.",
      translation: "女人没义务被人占有、侵犯、然后吐出来，就为了让某个人进化。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "I'm asking you to be as civilised as a god-damn bird Shane!",
      translation: "Shane,你做个人吧！",
    },
  ...
  },
  {
    ...
    quote: {
      original: "Please believe that I would do anything to see you happy. So, I do the only thing I can... I release you.",
      translation: "请你相信，为了你的幸福，我愿意付出一切。所以，我只能做出唯一的选择…… 放你自由。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "Reading can be learned, and I don't care if you curse or steal. But don't ever lie to me. Understood?",
      translation: "识字是可以学的，你骂人偷东西我也不在乎。但永远不要骗我。明白了吗？",
    },
  ...
  },
  {
    ...
    quote: {
      original: "I need to think. I need to become rich, sail off to a distant harbor, eat food I scarcely recognize, buy my fill of glittering baubles, and... not think of Hideko. Never think of Hideko.",
      translation: "我需要思考。我需要变得富有，扬帆远航到遥远的港口，吃我几乎认不出的食物，买下我梦寐以求的闪闪发光的珠宝，然后……不要去想秀子。永远不要去想秀子。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "To Tala, who finally had the courage to come out to her parents.",
      translation: "致Tala，终于有勇气向父母出柜。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "เราไม่ได้เรียกร้องความสนใจนะ ไม่ได้เรียกร้อง… ที่ทำไป เพราะเราอยากทำเอง",
      translation: "我没有想博取你的关注，真的没有...我所做的一切，只是我自己心甘情愿想做而已。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "Vivian Shing, I am asking you to dance with me.",
      translation: "薇薇安，我请妳与我共舞。",
    },
  ...
  },
  {
    ...
    quote: {
      original: "I love & only love the fairer sex & thus beloved by them in turn, my heart revolts from any other love than theirs.",
      translation: "我只爱女性，也被女性所爱，我的心抗拒除此之外的任何爱。",
    },
