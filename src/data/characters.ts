...
export const characters: Character[] = [
  ...
  },
  {
    ...
    quoteEn: "First, last and forever.",
    quoteCn: "你是我的最初，最终和永恒。",
  ...
  },
  {
    ...
    quoteEn: "I don’t do relationships.",
    quoteCn: "我不维系稳定恋爱关系。",
  ...
  },
  {
    ...
    quoteEn: "Lesbians think friendship is another word for foreplay!",
    quoteCn: "女同性恋总把友谊当成前戏的代名词！",
  ...
  },
  {
    ...
    quoteEn: "Every time I’m attracted to somebody she’s either unavailable or straight.",
    quoteCn: "每次我爱上一个人，她不是名花有主，就是直的。",
  ...
  },
  {
    ...
    quoteEn: "Does it make any difference if I'm fucking a beautiful woman for money?",
    quoteCn: "那又有什么区别？我为了钱跟漂亮女人上床，还不都是一回事？",
  ...
  },
  {
    ...
    quoteEn: "Je t’aime. Je n’ai jamais aimé personne d’autre que toi. Je ne veux que toi.",
    quoteCn: "我爱你。我从来只爱过你一个人。我只要你。",
  ...
  },
  {
    ...
    quoteEn: "Je suis avec quelqu'un maintenant. Mais j'ai une tendresse infinie pour toi. Je l'aurai toujours. Toute ma vie.",
    quoteCn: "我已经和别人在一起了，但我对你有着无限的温柔，永远如此，一生一世。",
  ...
  },
  {
    ...
    quoteEn: "Il choisit le souvenir d'Eurydice, c'est pour ça qu'il se retourne. Il ne fait pas le choix de l'amoureux, mais le choix du poète.",
    quoteCn: "他选择记住欧律狄刻，所以他才回头的。他做的不是爱人的选择，而是诗人的选择。",
  ...
  },
  {
    ...
    quoteEn: "Si vous me regardez. qui je regarde moi?",
    quoteCn: "当您注视画中人，我又注视谁呢？",
  ...
  },
  {
    ...
    quoteEn: "I wanna be with someone who, ten years from now, makes my heart jump when I hear her key in the door. The someone is you.",
    quoteCn: "我想和一个人在一起，十年后，听到她钥匙开门的声音，我依然会心跳加速。而那个人，就是你。",
  ...
  },
  {
    ...
    quoteEn: "Kiss me. Right here. In front of all these people.",
    quoteCn: "吻我，就在这里，在所有人面前。",
